...
public class EliminarCarritosYAñadirNuevo {
    ...
    public void eliminarCarritosYAñadirNuevo() {
        ...
        ViewInteraction appCompatButton2 = onView(
                allOf(withId(R.id.buttonEliminar), withText("Eliminar"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.carrito_list),
                                        1),
                                3),
                        isDisplayed()));
