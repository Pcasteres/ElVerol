...
public class ListaProductosNoLogAdapter
  ...
  public ListaProductosNoLogAdapter(View.OnClickListener listener) {
  ...
  @Override
  public void onBindViewHolder(final ListaProductosNoLogAdapter.ViewHolder holder, int position) {
