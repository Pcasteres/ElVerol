...
public class PrincipalLoginAdapter
    extends RecyclerView.Adapter<PrincipalLoginAdapter.ViewHolder> {

  private List<CategoryItem> itemList;
  private final View.OnClickListener clickListener;
  private String imagen;

  public PrincipalLoginAdapter(View.OnClickListener listener) {
